...
function build(){
 ...
 style.textContent=`
 .ddcfg-overlay{position:fixed;inset:0;z-index:150;display:none;align-items:center;justify-content:center;padding:18px;background:rgba(23,50,47,.46);backdrop-filter:blur(6px);font-family:Inter,system-ui,sans-serif;color:#16211f}.ddcfg-overlay.open{display:flex}
